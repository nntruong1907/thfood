...
<head>
    ...
    <meta content="TH Food" name="keywords">
    <meta content="TH Food" name="description">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="home.php" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">TH</span>Food</h1>
                </a>
            </div>
    ...
    <div class="container-fluid pt-5">
        ...
        ?>        
            <div class="row px-xl-5 pb-3">
                <p class="font-weight-bold text-dark ml-3" >
                Tìm thấy <?= $number_of_products; ?> sản phẩm 
                </p>
            </div>
        <?php
                }else{
                    echo '
                    <div class="row px-xl-5 pb-3">
                        <p class="font-weight-bold text-dark ml-3">Không tìm thấy sản phẩm!</p>
                    </div>';
                }
            }
        ?>
