        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>An Biên, Kiên Giang</p>
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>hab1910216@student.ctu.edu.vn</p>
			...
			$("#contactForm").validate({
				...
				messages: {
                    ...
                    msg: {
						...
						minlength: "Nội dung phải có ít nhất 5 ký tự"
					}
				},
				errorElement: "div",
